...
```
# Site settings
title: Xmeng Blog             # 你的博客网站标题
SEOTitle: Xmeng Blog			# 在后面会详细谈到
...
sidebar-avatar: /img/avatar-xmeng-home-original.jpg     #你的大头贴，请使用绝对地址.
```
...
我的博客标题是 **“Xmeng Blog”** 但是我想要在搜索的时候显示 **“黄玄的博客 | Xmeng Blog”** ，这个就需要SEO Title来定义了。
